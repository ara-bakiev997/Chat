...
public class UsersRepositoryJdbcTemplateImpl implements UsersRepository {
  ...
  public UsersRepositoryJdbcTemplateImpl(
      @Qualifier("usersRepositoryJdbcTemplate") JdbcTemplate jdbcTemplate,
      @Qualifier("usersRepositoryNamedParameterJdbcTemplate") NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
